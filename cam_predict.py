...
def init_pred ():
    ...
    TF_MODEL_FILE_PATH = 'ResNet50-STBv1.0_17.Lite'
...
def cam_predict(classify_lite,frame0):   # removing frame1
    ...
    conf = 100 * np.max(predictions_lite)
    ...
    #saving both images
    save_frame(pred_value, frame0, 0)
    # save_frame(pred_value[1], frame1, 1)

    # return conflict_resolution(pred_value,conf)  # this line is commented out inplace of the line below it
